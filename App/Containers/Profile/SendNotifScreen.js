...
export class SendNotifScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
  ...
  onSavePress = () => {
    ...
    const {sendNotifRequest} = this.props;
    ...
    sendNotifRequest(data, this.sendNotifCallback);
  };

  sendNotifCallback = result => {
...
const mapDispatchToProps = dispatch => ({
  sendNotifRequest: (data, callback) =>
    dispatch(InboxActions.sendNotifRequest(data, callback)),
});
